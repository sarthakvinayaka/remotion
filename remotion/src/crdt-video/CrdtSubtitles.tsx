...
import subtitles from "../crdt-subtitles.json";
...
// Whole-phrase cues that hold on screen for their full spoken duration, with
// per-word karaoke highlighting -- not a per-token sliding window, which
// reads as flickery since punctuation is its own whisper token.
export const CrdtSubtitles: React.FC<{ globalFrame: number }> = ({ globalFrame }) => {
