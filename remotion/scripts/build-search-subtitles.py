...
OpenAI price-cut video (searchengine.m4a).
...
captions = json.loads((ROOT / "src" / "search-captions.json").read_text())
...
TOKEN_MERGES = [
    (["photos", "ynthesis"], "photosynthesis"),
    (["token", "ized"], "tokenize"),
    (["token", "ize"], "tokenize"),
    (["default", "dict"], "defaultdict"),
    (["page", "rank"], "PageRank"),
    (["wh", "ichever"], "Whichever"),
    (["mult", "ip", "ly"], "Multiply"),
    (["in", "verse"], "inverse"),
    (["look", "ups"], "lookups"),
    (["tf-id", "f"], "TF-IDF"),
...
PHRASE_FIXES = [
    # --- factual: contradicts the code/graphic on screen ---
    # ASR heard "dog" as "doc" at the payoff moment -- this is THE result line
    (["now", "the", "doc", "document", "is", "first"], ["Now", "the", "dog", "document", "is", "first"]),
    # "how rare the document is" -> it is the WORD's rarity that matters; the
    # whole point of IDF. Leaving this in would teach the concept backwards.
    (["how", "rare", "the", "document", "is", "across"], ["how", "rare", "the", "word", "is", "across"]),
    # --- clear mishearings ---
    (["it", "reads", "billions", "of", "pages"], ["it", "read", "billions", "of", "pages"]),
    (["every", "pages", "that"], ["every", "page", "that"]),
    (["at", "back", "find"], ["at", "the", "back,", "find"]),
    (["which", "page", "to", "look", "at"], ["which", "pages", "to", "look", "at"]),
    (["and", "build", "an", "index"], ["and", "builds", "an", "index"]),
    (["to", "search", "though"], ["to", "search", "through"]),
    (["a", "token", "ized", "function"], ["a", "tokenize", "function"]),
    (["so", "that", "cat", "and", "cat", "count"], ["so", "that", "Cat", "and", "cat", "count"]),
    (["if", "someone", "search", "for", "cat"], ["if", "someone", "searches", "for", "cat"]),
    (["contains", "the", "search", "word", "the", "most", "it", "wins"],
     ["contains", "the", "search", "words", "the", "most", "times", "wins"]),
    (["so", "the", "cat", "document", "win"], ["so", "the", "cat", "document", "wins"]),
    (["so", "common", "word", "should", "count"], ["so", "common", "words", "should", "count"]),
    (["and", "rare", "word", "should", "count"], ["and", "rare", "words", "should", "count"]),
    (["both", "are", "simple", "than"], ["both", "are", "simpler", "than"]),
    (["appears", "in", "that", "document", "relative"], ["appears", "in", "this", "document,", "relative"]),
    (["those", "two", "idea", "one", "line"], ["those", "two", "ideas,", "one", "line"]),
    (["the", "search", "is", "almost", "identical"], ["Then", "search", "is", "almost", "identical"]),
    (["growing", "to", "aggressively"], ["growing", "too", "aggressively"]),
    (["a", "real", "one", "adds", "a", "lot"], ["Real", "ones", "add", "a", "lot"]),
    (["hundreds", "of", "other", "signal"], ["hundreds", "of", "other", "signals"]),
    (["if", "you", "want", "to", "follow", "where"], ["If", "you", "want", "a", "follow-up", "where"]),
    (["let", "me", "know", "in", "comments"], ["let", "me", "know", "in", "the", "comments"]),
...
out_path = ROOT / "src" / "search-subtitles.json"
